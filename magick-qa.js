 ...
 */
let MagickQA = class MagickQA extends LitElement {
    constructor() {
        super(...arguments);
        /**
        ...
        this.isCardCreationActive = false; // Track the state of card creation mode
    }
    render() {
        return html `
    ...
    toggleCardCreationMode() {
        ...
        const threads = this.shadowRoot?.querySelector("magick-qa-threads");
        if (threads) {
...
__decorate([
    property()
], MagickQA.prototype, "name", void 0);
__decorate([
    property({ type: Number })
], MagickQA.prototype, "count", void 0);
__decorate([
    state()
], MagickQA.prototype, "isMenuOpen", void 0);
__decorate([
    state()
], MagickQA.prototype, "isCardCreationActive", void 0);
MagickQA = __decorate([
    customElement("magick-qa")
], MagickQA);
export { MagickQA };
//# sourceMappingURL=magick-qa.js.map